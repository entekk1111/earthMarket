    ...
    <form
      ...
      <div class="join-wrap layout">
        ...
        <div class="sns-group">
          ...
          <ul>
            <li class="ico ico01">
              <a href="javascript:void(0);"><span class="sr-only">카카오톡로그인</span></a>
            </li>
            <li class="ico ico02">
              <a href="javascript:void(0);"><span class="sr-only">네이버로그인</span></a>
            </li>
          </ul>
        </div>
        <!-- // sns-group -->
          ...
          <li>
            ...
            <b-collapse id="collapse1">
              <div class="pwd-auth">
                ...
                <div class="input-wrap">
                  <label for="authNum"><span class="sr-only">인증번호입력</span></label>
                  <input
                    type="text"
                    id="authNum" />
                  <button
        ...
        <div class="checkbox-group">
          ...
          <div class="chbox_wrap">
            ...
            <label
              for="agency_type_100"
              class="idSave"><span class="txt">필수동의 항목 및 개인정보 수집 및 이용 동의, 마케팅 정보 수신에
                모두 동의합니다.</span></label>
          </div>
        </div>
        <!--  //checkbox-group -->
